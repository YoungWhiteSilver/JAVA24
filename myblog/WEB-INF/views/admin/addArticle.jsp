            ...
            <form action="/admin/addArticleServlet" method="post" class="form-horizontal" id="editForm">
              <br>
               <div class="form-group">
                  <input type="text" class="form-control" placeholder="请输入主题标题" id="title" name="title">
               </div>
               <div class="form-group">
                  <input type="text" class="form-control" placeholder="请为主题贴上标签，多个标签使用，号分开" id="label" name="label">
               </div>
               <div class="form-group"> 
                  <textarea name="editor" class="from-control" id="editor"  placeholder="正文从这里开始..." ></textarea>
               </div>
               ...
               <br>
               <div class="form-group">
                  <button class="btn btn-primary" id="btnForm">发布文章</button>
               </div>
            </form>
  ...
  $(function(){
    	...
    	$("#editForm").validate({
    		...
    		submitHandler : function(form) {
  			  $.ajax({
  				  url : "/admin/addArticleServlet",
  				  type : "post",
  				  data : $(form).serialize(),
  				  beforeSend : function() {
  					  $("#btnForm").text("正在发布文章").attr("disabled", "disabled");
  				  },
  				  ...
  				  complete : function() {
  					  ...
  					  $("#btnForm").text("发布文章").removeAttr("disabled", "disabled");
  				  }
  			  })
  		  }
    	});
