...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form method="post" id="formSubmit">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="stuAge" name="stuAge" value="${student.stuAge}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <select name="stuClass" class="form-control">
                        ...
                        <c:forEach items="${stuClassList}" var="studentClass">
                            <option value="${studentClass.id}" ${student.studentClass.id == studentClass.id ? 'selected' : ''}>${studentClass.className}</option>
                        </c:forEach>
                    </select>
                </div>
            </form>
        ...
        <div class="panel-footer">
            ...
            <a class="btn btn-default" href="/student/${student.id}">返回</a>
        </div>
    </div>
</div>
